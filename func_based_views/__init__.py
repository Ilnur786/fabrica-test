# Common pattern name is MVC (model-view-control), that why package name is "controllers"
# In python (clearly in Django) that is MTV (model-template-view), and here is "views"
